<?php
// ...existing code for fetching $subject by id...
?>
<!DOCTYPE html>
<html lang="bn">
<head>
    <meta charset="UTF-8">
    <title>বিষয় এডিট করুন</title>
...
<body class="container py-5">
    <div class="card">
        <div class="card-body">
            <h2 class="mb-4 text-warning text-center"><i class="fa fa-pen"></i> বিষয় এডিট করুন</h2>
            <?php if (!empty($error)): ?>
            ...
            <form method="post">
                ...
                <div class="mb-3">
                    <label class="form-label">ক্লাস আইডি</label>
                    <input type="number" name="class_id" class="form-control" value="<?= htmlspecialchars($subject['class_id']) ?>" required>
                </div>
                <div class="btn-container">
                    <button type="submit" class="btn btn-warning btn-lg-custom">Update</button>
                    <a href="router.php?action=subject_index" class="btn btn-secondary btn-lg-custom">Back</a>
                </div>
            </form>
        </div>
    </div>
