...
<body class="container py-5">
    <h2 class="mb-4 text-primary">নতুন ফি যোগ করুন</h2>
    ...
    <form method="post">
        ...
        <div class="mb-3">
            <label class="form-label">ডিউ তারিখ</label>
            <input type="date" name="due_date" class="form-control">
        </div>
        <div class="mb-3">
            <label class="form-label">পেইড তারিখ</label>
