<?php
// ...existing code for fetching $class by id...
?>
<!DOCTYPE html>
<html lang="bn">
<head>
    <meta charset="UTF-8">
    <title>ক্লাস এডিট করুন</title>
...
<body class="container py-5">
    <div class="card">
        <div class="card-body">
            <h2 class="mb-4 text-warning text-center"><i class="fa fa-pen"></i> ক্লাস এডিট করুন</h2>
            <?php if (!empty($error)): ?>
            ...
            <form method="post">
                ...
                <div class="btn-container">
                    ...
                    <a href="router.php?action=class_index" class="btn btn-secondary btn-lg-custom">Back</a>
                </div>
            </form>
        </div>
    </div>
