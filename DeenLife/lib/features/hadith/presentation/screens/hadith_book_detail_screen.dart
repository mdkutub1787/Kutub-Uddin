...
class HadithBookDetailScreen extends ConsumerStatefulWidget {
  final HadithBook book;

  const HadithBookDetailScreen({super.key, required this.book});

  @override
  ConsumerState<HadithBookDetailScreen> createState() =>
      _HadithBookDetailScreenState();
}

class _HadithBookDetailScreenState extends ConsumerState<HadithBookDetailScreen> {
  String _searchQuery = '';
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => HadithSectionScreen(
