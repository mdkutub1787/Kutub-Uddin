                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String titleBn = isDefault
                          ? 'অনুবাদ'
                          : allTafsirs[index - 1].name;
                      final String subtitleEn = isDefault
                          ? 'Translation (Default)'
                          : allTafsirs[index - 1].authorName;
                      final int? tafsirId = isDefault
                          ? null
                          : allTafsirs[index - 1].id;
                      final bool isSelected = currentTafsirId == tafsirId;

                      return GestureDetector(
                        onTap: () {
                          ref.read(selectedTafsirIdProvider.notifier).state =
                              tafsirId;
