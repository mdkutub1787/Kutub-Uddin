        ...
        child: Stack(
          children: [
            Positioned(
              right: -30,
              top: -30,
              child: Icon(Icons.local_mall_rounded, size: 200, color: Colors.white.withOpacity(0.1)),
            ),
            Padding(
      ...
      child: Column(
        children: [
          UserAccountsDrawerHeader(
            ...
            accountName: Text(AppStrings.appName.tr()),
            accountEmail: Text(authViewModel.user?.email ?? ""),
