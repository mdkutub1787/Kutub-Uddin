                    ...
                    children: [
                        ...
                        children: [
                          ...
                          if (ref.watch(adminShopFilterProvider) != null)
                            TextButton.icon(
                              ...
                              onPressed: () {
                                ref
                                        .read(adminShopFilterProvider.notifier)
                                        .state =
                                    null;
                                ref
                                        .read(
                                          adminShopFilterNameProvider.notifier,
                                        )
                                        .state =
                                    null;
                              },
                      ...
                      if (ref.watch(adminShopFilterNameProvider) != null)
                        Padding(
                          ...
                          child: Text(
                            "Viewing: ${ref.watch(adminShopFilterNameProvider)}",
                      ...
                      if (orders.isNotEmpty)
                        _buildOrderPieChart(orders, settings.primaryColor),
                        ...
                        children: [
                          ...
                          if (isStaff)
                            _buildAdminCard(
                              ...
                              Colors.blue,
                              "${products.length} ${AppStrings.pieces.tr()}",
                              () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) =>
                          ...
                          if (isManager)
                            _buildAdminCard(
                              ...
                              Colors.orange,
                              "${categories.length} ${AppStrings.items.tr()}",
                              () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) =>
                          ...
                          if (isSuperAdmin)
                            _buildAdminCard(
                              ...
                              Colors.red,
                              "${noticeState.value?.length ?? 0} ${AppStrings.active.tr()}",
                              () => Navigator.pushNamed(
                                context,
                          ...
                          if (isManager)
                            _buildAdminCard(
                              ...
                              badgeCount: supportState.value?.length ?? 0,
                            ),
                          ...
                          if (isSuperAdmin)
                            _buildAdminCard(
                              ...
                              () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => const AdminShopListScreen(),
                                ),
                              ),
                            ),
