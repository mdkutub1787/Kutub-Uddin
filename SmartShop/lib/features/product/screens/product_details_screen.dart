                      ...
                      Container(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [Colors.black.withValues(alpha: 0.4), Colors.transparent, Colors.black.withValues(alpha: 0.1)],
                          )
                        ),
                      )
                    ],
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text('Category', style: TextStyle(color: primaryColor, fontWeight: FontWeight.bold, fontSize: 12)),
                        ),
                        Row(
                          children: [
