...
public class V1_CustomLinkingInputAdapter extends BaseAdapter {
    private Context context;

    public V1_CustomLinkingInputAdapter(Context context) {
        this.context = context;
    }

    @Override
    public int getCount() {
        return V1_LineWiseSewingInputActivity.modelArrayList.size();
    }

    @Override
    public Object getItem(int position) {
        return V1_LineWiseSewingInputActivity.modelArrayList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // holder.slNumber.setText(SewingInputActivity.modelArrayList.get(position).getId());
        holder.bundleNotv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getBundle_no());
        holder.yeartv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getYearNo());
        holder.jobNotv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getJobNo());
        holder.buyertv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getBuyer());
        holder.orderNotv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getOrderNo());
        holder.gmtsItemtv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getItemNo());
        holder.countrytv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getCountry());
        holder.colortv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getColorNo());
        holder.sizetv.setText(V1_LineWiseSewingInputActivity.modelArrayList.get(position).getSizeNo());
