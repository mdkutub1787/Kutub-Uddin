...
public class V1_BundleWiseSewingOutputClass {
    ...
    public class Resultset {
        ...
        @Expose
        private Integer sewingInputLine;
        @SerializedName("replace_field_disable")
        @Expose
        private Integer replaceFieldDisable;
        ...
        public Integer getSewingInputLine() {
            return sewingInputLine;
        }

        public void setSewingInputLine(Integer sewingInputLine) {
            this.sewingInputLine = sewingInputLine;
        }

        public Integer getReplaceFieldDisable() {
            return replaceFieldDisable;
        }

        public void setReplaceFieldDisable(Integer replaceFieldDisable) {
