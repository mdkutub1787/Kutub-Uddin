...
public class V1_LineSewingInputModelClass {
    private int id;
    ...
    public V1_LineSewingInputModelClass() {
    }
    ...
    public V1_LineSewingInputModelClass(String cut_no, String bundle_no, String barcode_no, int order_id, int item_id, int country_id, int color_id, int size_id, int color_size, int quantity, int is_rescan, String yearNo, String jobNo, String buyer, String orderNo, String itemNo, String country, String colorNo, String sizeNo) {
        this.cut_no = cut_no;
        this.bundle_no = bundle_no;
        this.barcode_no = barcode_no;
        this.order_id = order_id;
