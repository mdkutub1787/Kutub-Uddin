...
public class V1_SewingOutputDefectRecyclerAdapter extends RecyclerView.Adapter<V1_SewingOutputDefectRecyclerAdapter.ViewHolder> {
        List<V1_SewingDefectModel> sewingDefectTypeArrayList;
        Context context;
        private OnDefectSelectListener mOnImageHeadListener;

        public V1_SewingOutputDefectRecyclerAdapter(List<V1_SewingDefectModel> sewingDefectTypeArrayList, Context context, OnDefectSelectListener mOnDefectSelectListener) {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
                private TextView  defectName, defectCount;
