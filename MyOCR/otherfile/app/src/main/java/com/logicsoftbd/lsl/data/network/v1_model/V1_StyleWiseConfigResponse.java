...
public class V1_StyleWiseConfigResponse {
	...
	public class V1_DataItem {
		...
		@SerializedName("AUTO_DISTRIBUTION")
		@Expose
		private String autoDistribution;
		...
		public String getAutoDistribution() {
			return autoDistribution;
		}

		public void setAutoDistribution(String autoDistribution) {
