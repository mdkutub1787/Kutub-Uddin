...
import com.logicsoftbd.lsl.databinding.ActivityTransferInForPdaDeviceBinding;
...
public class V1_TransferInForPDADeviceActivity extends AppCompatActivity implements DeleteItemFromTransferInInterface {
    private ActivityTransferInForPdaDeviceBinding binding;
    private static final String TAG = "V1_TransferInForPDADevi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTransferInForPdaDeviceBinding.inflate(getLayoutInflater());
...
//        listOfBarcodeOnlySingleUI = listOfAllBarcode;
    ...
    private void callAdapter(List<DtlsPart> listOfBarcode) {
        adapter = new V1_transfer_in_recycler_adapter(V1_TransferInForPDADeviceActivity.this, listOfBarcode);
    ...
    private void showMessageWithSweetAlert(String msg) {
        new SweetAlertDialog(V1_TransferInForPDADeviceActivity.this, SweetAlertDialog.WARNING_TYPE)
...
//                    startScanning(2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_save) {
            showAlertMessageForGettingPermission("Are you want to save?");
            return true;
        }
