...
public class V1_LineSewingOutputModelClass {
    private int id;
    ...
    public V1_LineSewingOutputModelClass() {
    }

    public V1_LineSewingOutputModelClass(int id, String cut_no, String bundle_no, String barcode_no, int order_id, int item_id, int country_id, int color_id, int size_id, int color_size, int quantity, int replace_qty, int is_rescan, String yearNo, String jobNo, String buyer, String orderNo, String itemNo, String country, String colorNo, String sizeNo, int reject, int alter, int spot, int replace, int qc_qty) {
        this.id = id;
        this.cut_no = cut_no;
