...
public class V2_ColorSpinnerAdapter extends ArrayAdapter<V2_POWiseColorModel> {

    public V2_ColorSpinnerAdapter(Context context, List<V2_POWiseColorModel> colorArrayList)
    {
                          ...
                          ViewGroup parent)
    {
        ...
        V2_POWiseColorModel currentItem = getItem(position);
