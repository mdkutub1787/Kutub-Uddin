...
public class V1_RejectPopUpRecyclerAdapter extends RecyclerView.Adapter<V1_RejectPopUpRecyclerAdapter.ViewHolder> {
        List<V1_SewingRejectModel> sewingDefectTypeArrayList;
        Context context;
        private OnDefectSelectListener mOnImageHeadListener;

        public V1_RejectPopUpRecyclerAdapter(List<V1_SewingRejectModel> sewingDefectTypeArrayList, Context context, OnDefectSelectListener mOnDefectSelectListener) {
        ...
        @NonNull
        @Override
        public V1_RejectPopUpRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        @Override
        public void onBindViewHolder(@NonNull V1_RejectPopUpRecyclerAdapter.ViewHolder viewHolder, int position) {
