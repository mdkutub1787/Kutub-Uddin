...
public class V1_GreyFabricRollIssueForPDODeviceActivity extends AppCompatActivity implements View.OnClickListener,  V1_GreyRollIssueRecyclerViewAdapter.OnMoreHeadListener, V1_GreyRollIssueRecyclerViewAdapter.OnRemoveHeadListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grey_fabric_roll_issue_pdo_device);
                ...
                if(apiResponse.getResultset().getStatus().equals("Failed")){
                    ...
                    if (greyRollIssueItemModels.size() > 0) {
                        ...
                        for (int j = 0; j < greyRollIssueItemModels.size(); j++) {
                            if (greyRollIssueItemModels.get(j).getBarcodeNo().equals(_barcodeScanTV.getText().toString())) {
    ...
    private void calculateTotalRollWeight() {
        ...
        if(greyRollIssueItemModels != null && greyRollIssueItemModels.size() > 0) {
            _totalRollTV.setText("Total Roll : " + greyRollIssueItemModels.size());
        }
    }
    ...
    private void setPurposeAdapterData() {
        try {
            ArrayAdapter<String> adapterCompany = new ArrayAdapter<String>(this, R.layout.pdo_spinner_layout, purposeListName);
            ...
            _purposeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    purpose_id = purposeListId.get(purposePosition);
            ...
            Log.d(TAG, "setPurposeAdapterData: "+e.getMessage());
        }
    }

    private void setCompanyAdapterData() {
        ArrayAdapter<String> adapterCompany = new ArrayAdapter<String>(this, R.layout.pdo_spinner_layout, companyNameArray);
    ...
    private void setSourceAdapterData() {
        ArrayAdapter<String> adapterSource = new ArrayAdapter<String>(this, R.layout.pdo_spinner_layout, sourceArray);
    ...
    private void setDyeingCompanyAdapterData() {
        ...
        ArrayAdapter<String> adapterSource = new ArrayAdapter<String>(this, R.layout.pdo_spinner_layout, dyingCompanyArray);
...
//                    showAlertMessage("Please Refresh Barcode first.", 0, 0);
    ...
    private void showAlertMessage(String msg, int i, int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(V1_GreyFabricRollIssueForPDODeviceActivity.this);
