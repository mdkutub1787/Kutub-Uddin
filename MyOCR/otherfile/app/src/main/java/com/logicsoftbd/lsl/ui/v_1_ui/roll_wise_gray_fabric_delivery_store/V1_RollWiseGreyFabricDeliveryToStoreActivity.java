...
public class V1_RollWiseGreyFabricDeliveryToStoreActivity extends AppCompatActivity implements View.OnClickListener,  V1_RollWiseGrayFabricDeliveryToStoreRecyclerViewAdapter.OnRemoveHeadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grey_fabric_delivery_to_store);
    ...
    private void postDataToServer() {
        ...
        try {
            ...
            data_obj.put("txt_remarks", _remarkET.getText().toString());
...
//        datePickerDialog.show();
    ...
    private void startScanning(int op, int grey_roll_status) {
        ...
        intent.putExtra("qc", "grey_roll_delivery_v1");
        intent.putExtra("scan_op", op);
        intent.putExtra("grey_roll_data", grayRollDeliveryItemModels);
    ...
    private void showAlertMessage(String msg, int i, int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(V1_RollWiseGreyFabricDeliveryToStoreActivity.this);
