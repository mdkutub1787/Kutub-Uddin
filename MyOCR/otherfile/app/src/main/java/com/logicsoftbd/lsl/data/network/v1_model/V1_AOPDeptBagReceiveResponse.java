...
public class V1_AOPDeptBagReceiveResponse {
    @SerializedName("status")
    @Expose
    private Boolean status;
    @SerializedName("result_set")
    @Expose
    private ArrayList<V1_AOPDeptBagReceiveResponse.ResultSet> resultSet;
    ...
    public ArrayList<V1_AOPDeptBagReceiveResponse.ResultSet> getResultSet() {
        return resultSet;
    }

    public void setResultSet(ArrayList<V1_AOPDeptBagReceiveResponse.ResultSet> resultSet) {
