package com.logicsoftbd.lsl.posPrinter;
...
import com.logicsoftbd.lsl.posPrinter.textparser.IPrinterTextParserElement;
import com.logicsoftbd.lsl.posPrinter.textparser.PrinterTextParser;
import com.logicsoftbd.lsl.posPrinter.textparser.PrinterTextParserColumn;
import com.logicsoftbd.lsl.posPrinter.textparser.PrinterTextParserLine;
import com.logicsoftbd.lsl.posPrinter.textparser.PrinterTextParserString;
...
public class EscPosPrinter extends EscPosPrinterSize {
    ...
    public EscPosPrinter printFormattedTextAndCut(String text) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        return this.printFormattedTextAndCut(text, 2f);
    }
