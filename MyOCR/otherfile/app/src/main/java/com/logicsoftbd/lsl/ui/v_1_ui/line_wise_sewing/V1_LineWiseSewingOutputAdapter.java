...
public class V1_LineWiseSewingOutputAdapter extends ArrayAdapter<V1_LineSewingOutputModelClass> {

    ArrayList<V1_LineSewingOutputModelClass> lineSewingOutputModelClasses;
    LayoutInflater vi;
    private int Resource, qty = 0, qc_qty = 0, reject_number = 0, alter_number = 0, spot_number = 0, replace_number = 0;

    public V1_LineWiseSewingOutputAdapter(@NonNull Context context, int resource, ArrayList<V1_LineSewingOutputModelClass> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder = new V1_LineWiseSewingOutputAdapter.ViewHolder();
        qty = lineSewingOutputModelClasses.get(position).getQuantity();
        qc_qty = qty;

        if(convertView == null)
        {
            convertView = vi.inflate(R.layout.sewing_output_line_object_layout, null);
