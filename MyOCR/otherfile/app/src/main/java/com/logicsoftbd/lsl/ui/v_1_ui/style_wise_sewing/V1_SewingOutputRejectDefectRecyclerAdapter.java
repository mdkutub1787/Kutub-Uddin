...
public class V1_SewingOutputRejectDefectRecyclerAdapter extends RecyclerView.Adapter<V1_SewingOutputRejectDefectRecyclerAdapter.ViewHolder> {
        List<V1_SewingRejectModel> sewingDefectTypeArrayList;
        Context context;
        private OnRejectDefectSelectListener mOnImageHeadListener;

        public V1_SewingOutputRejectDefectRecyclerAdapter(List<V1_SewingRejectModel> sewingDefectTypeArrayList, Context context, OnRejectDefectSelectListener mOnDefectSelectListener) {
