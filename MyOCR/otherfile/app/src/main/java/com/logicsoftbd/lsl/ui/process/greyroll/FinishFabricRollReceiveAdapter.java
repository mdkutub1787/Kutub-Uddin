...
public class FinishFabricRollReceiveAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private FinishFabricRollReceiveAdapter.Callback mCallback;
    private List<FinishFabricRollReceive.DetailsSet> mProcessResponseList = new ArrayList<>();

    public FinishFabricRollReceiveAdapter(List<FinishFabricRollReceive.DetailsSet> openSourceResponseList) {
        mProcessResponseList = openSourceResponseList;
    }

    public void setCallback(FinishFabricRollReceiveAdapter.Callback callback) {
        mCallback = callback;
    }
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_NORMAL:
                return new FinishFabricRollReceiveAdapter.ViewHolder(
                        LayoutInflater.from(parent.getContext()).inflate(R.layout.card_item_gmts, parent, false));
            case VIEW_TYPE_EMPTY:
            default:
                return new FinishFabricRollReceiveAdapter.EmptyViewHolder(
    ...
    public void addItems(List<FinishFabricRollReceive.DetailsSet> repoList) {
        if(mProcessResponseList != null && mProcessResponseList.size() > 0)
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(final int position) {
            ...
            final FinishFabricRollReceive.DetailsSet repo = mProcessResponseList.get(position);
            ...
            if(Integer.parseInt(repo.getQNTY()) > 0) {
