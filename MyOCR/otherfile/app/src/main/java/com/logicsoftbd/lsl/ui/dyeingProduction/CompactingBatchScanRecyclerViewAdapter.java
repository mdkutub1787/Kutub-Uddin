...
public class CompactingBatchScanRecyclerViewAdapter extends RecyclerView.Adapter<CompactingBatchScanRecyclerViewAdapter.ViewHolder> {
    private Context context;
    private List<CompactBatchScanResponse.DtlsIndex> dtlsIndexArrayList = new ArrayList<>();

    public CompactingBatchScanRecyclerViewAdapter(Context context, List<CompactBatchScanResponse.DtlsIndex> dtlsIndexArrayList) {
    ...
    @NonNull
    @Override
    public CompactingBatchScanRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.compacting_details_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CompactingBatchScanRecyclerViewAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder   {
        TextView _slTV, _cons_compositeTV, _gsmTV, _dia_widthTV, _d_w_widthTV, _roll_noTV, _barcodeTV, _batchQtyTV, _prodQtyTV, _rateTV, _amountTV;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            _rateTV = itemView.findViewById(R.id.rateTV);
            _amountTV = itemView.findViewById(R.id.amountTV);
