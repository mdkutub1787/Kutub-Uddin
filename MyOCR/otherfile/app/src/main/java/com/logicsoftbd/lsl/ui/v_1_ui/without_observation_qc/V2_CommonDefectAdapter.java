...
public class V2_CommonDefectAdapter extends RecyclerView.Adapter<V2_CommonDefectAdapter.ViewHolder> {
    private static final String TAG = "FinishProductionSlittin";
    List<V1_BarcodeDetailsFromBatchFinishQCResponse.Common> dtlsIndexArrayList;
    Context context;
    OnCommonHeadListener mOnSelectListener;

    public V2_CommonDefectAdapter(List<V1_BarcodeDetailsFromBatchFinishQCResponse.Common> dtlsIndexArrayList, Context context, OnCommonHeadListener mOnSelectListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull V2_CommonDefectAdapter.ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        OnCommonHeadListener onCommonDefectClick;

        public ViewHolder(@NonNull View itemView, OnCommonHeadListener onSelectClick) {
            super(itemView);
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.defectNameTV) {
                onCommonDefectClick.onCommonDefectClick(getAdapterPosition(), v);
            }
        }
    }

    public interface OnCommonHeadListener {
        void onCommonDefectClick(int position, View v);
    }
}
