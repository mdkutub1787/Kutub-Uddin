...
public class V1_DyedAOPDeptReceiveRecyclerViewAdapter extends RecyclerView.Adapter<V1_DyedAOPDeptReceiveRecyclerViewAdapter.ViewHolder> {
    private List<V1_DyedAOPBagReceiveResponse.ResultSet> bagKeepingResponses;
    private Context context;
    private OnRemoveHeadListener mOnRemoveHeadListener;

    public V1_DyedAOPDeptReceiveRecyclerViewAdapter(List<V1_DyedAOPBagReceiveResponse.ResultSet> bagKeepingResponses, OnRemoveHeadListener mOnRemoveHeadListener, Context context) {
    ...
    @NonNull
    @Override
    public V1_DyedAOPDeptReceiveRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        V1_DyedAOPBagReceiveResponse.ResultSet currentItem = bagKeepingResponses.get(position);
