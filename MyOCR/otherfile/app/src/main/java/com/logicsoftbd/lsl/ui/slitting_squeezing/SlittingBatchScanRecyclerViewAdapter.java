...
public class SlittingBatchScanRecyclerViewAdapter extends RecyclerView.Adapter<SlittingBatchScanRecyclerViewAdapter.ViewHolder> {
    private Context context;
    private List<SlitteringSequzBarCodeResponse.DtlsIndex> dtlsIndexArrayList = new ArrayList<>();

    public SlittingBatchScanRecyclerViewAdapter(Context context, List<SlitteringSequzBarCodeResponse.DtlsIndex> dtlsIndexArrayList) {
    ...
    @NonNull
    @Override
    public SlittingBatchScanRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.slittering_sequezzing_details_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SlittingBatchScanRecyclerViewAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder   {
        TextView _slTV, _cons_compositeTV, _gsmTV, _dia_widthTV, _d_w_widthTV, _roll_noTV, _barcodeTV, _prodQtyTV;
