...
public class SewingAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private List<SewingResponse.Result.MasterPart> mProcessResponseList = new ArrayList<>();

    public SewingAdapter(List<SewingResponse.Result.MasterPart> openSourceResponseList) {
    ...
    public void addItems(List<SewingResponse.Result.MasterPart> repoList) {
        if(mProcessResponseList != null && mProcessResponseList.size() > 0)
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(final int position) {
            ...
            final SewingResponse.Result.MasterPart repo = mProcessResponseList.get(position);


            if(repo.getProductionType() == 4) {
