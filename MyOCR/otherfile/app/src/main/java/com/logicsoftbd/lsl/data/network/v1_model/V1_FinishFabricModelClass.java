...
public class V1_FinishFabricModelClass {
    ...
    public class Index {
        ...
        @SerializedName("wgt_lost_qnty")
        @Expose
        private String wgt_lost_qnty;
        ...
        public String getWgt_lost_qnty() {
            return wgt_lost_qnty;
        }

        public void setWgt_lost_qnty(String wgt_lost_qnty) {
            this.wgt_lost_qnty = wgt_lost_qnty;
        }
    }
    public class Grade {
