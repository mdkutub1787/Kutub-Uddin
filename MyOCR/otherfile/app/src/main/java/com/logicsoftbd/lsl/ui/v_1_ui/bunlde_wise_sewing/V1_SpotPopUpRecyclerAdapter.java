...
public class V1_SpotPopUpRecyclerAdapter extends RecyclerView.Adapter<V1_SpotPopUpRecyclerAdapter.ViewHolder> {
        List<V1_SewingSpotModel> sewingDefectTypeArrayList;
        Context context;
        private OnDefectSelectListener mOnImageHeadListener;

        public V1_SpotPopUpRecyclerAdapter(List<V1_SewingSpotModel> sewingDefectTypeArrayList, Context context, OnDefectSelectListener mOnDefectSelectListener) {
        ...
        @NonNull
        @Override
        public V1_SpotPopUpRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        @Override
        public void onBindViewHolder(@NonNull V1_SpotPopUpRecyclerAdapter.ViewHolder viewHolder, int position) {
