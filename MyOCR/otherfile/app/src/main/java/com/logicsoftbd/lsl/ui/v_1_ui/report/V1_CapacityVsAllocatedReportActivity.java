...
import com.logicsoftbd.lsl.data.network.v1_model.V1_CapacityVsAllocatedOrderModel;
...
public class V1_CapacityVsAllocatedReportActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "V1_CapacityVsAllocatedReportActivity";
    ...
    public final ArrayList<String> allocatedMinuteList = new ArrayList<>();
    ...
    public String[] allocatedMinuteArray, capacityMinuteArray;
    public static ArrayList<V1_CapacityVsAllocatedOrderModelClass> modelArrayList;
    private V1_CapacityVsAllocatedAdapter capacityVsAllocatedAdapter;
    private GridView planBookedGridView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_v1_capacity_vs_allocated_report);
        ...
        alertDialogBuilder = new android.app.AlertDialog.Builder(V1_CapacityVsAllocatedReportActivity.this);
        ...
        apiInterface.getBundkeWiseSewingInputClassCall().enqueue(new Callback<V1_BundleWiseSewingInputClass>() {
            ...
            public void onFailure(Call<V1_BundleWiseSewingInputClass> call, Throwable t) {
                if (t instanceof IOException) {
                    Toast.makeText(V1_CapacityVsAllocatedReportActivity.this, "No network available, please check your WiFi or Data connection", Toast.LENGTH_SHORT).show();
                    hideDialog();
                }
                else {
    ...
    private void setAdapterData_Location() {
        ArrayAdapter<String> adapterLocation = new ArrayAdapter<String>(V1_CapacityVsAllocatedReportActivity.this, R.layout.sewing_spinner_layout, locationNameArray);
    ...
    private void showReportFromServer() {
        showDialog();
        apiInterface.getCapacityVsBookedModelCall(companyId, locationId, startButton.getText().toString(), endButton.getText().toString()).enqueue(new Callback<V1_CapacityVsAllocatedOrderModel>() {
            @Override
            public void onResponse(Call<V1_CapacityVsAllocatedOrderModel> call, Response<V1_CapacityVsAllocatedOrderModel> response) {
                if(response.isSuccessful()){
                    hideDialog();
                    plan_vs_booked.setVisibility(View.GONE);
                    monthNameTV.setText(String.valueOf(response.body().getData().get(0).getMonth()));

                    V1_CapacityVsAllocatedOrderModel.Datum rCompanyName;
                    final List<V1_CapacityVsAllocatedOrderModel.Datum> CompanyName = response.body().getData();
                    for(V1_CapacityVsAllocatedOrderModel.Datum d : CompanyName)
                    {
                        rCompanyName = d;
                        final V1_CapacityVsAllocatedOrderModel.Datum finalName = rCompanyName;
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                    ...
                    V1_CapacityVsAllocatedOrderModel.Datum rLocationName;
                    final List<V1_CapacityVsAllocatedOrderModel.Datum> LocationName = response.body().getData();
                    for(V1_CapacityVsAllocatedOrderModel.Datum d : LocationName)
                    {
                        rLocationName = d;
                        final V1_CapacityVsAllocatedOrderModel.Datum finalName = rLocationName;
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                    ...
                    V1_CapacityVsAllocatedOrderModel.Datum rMonth;
                    final List<V1_CapacityVsAllocatedOrderModel.Datum> MonthName = response.body().getData();
                    for(V1_CapacityVsAllocatedOrderModel.Datum d : MonthName)
                    {
                        rMonth = d;
                        final V1_CapacityVsAllocatedOrderModel.Datum finalName = rMonth;
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                    ...
                    V1_CapacityVsAllocatedOrderModel.Datum rPlanMinute;
                    final List<V1_CapacityVsAllocatedOrderModel.Datum> PlanMinute = response.body().getData();
                    for(V1_CapacityVsAllocatedOrderModel.Datum d : PlanMinute)
                    {
                        rPlanMinute = d;
                        final V1_CapacityVsAllocatedOrderModel.Datum finalName = rPlanMinute;
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                allocatedMinuteList.add((String.valueOf(finalName.getAllocatedMinute())));
                            }
                        });
                    }

                    V1_CapacityVsAllocatedOrderModel.Datum rBookedMinute;
                    final List<V1_CapacityVsAllocatedOrderModel.Datum> BookedMinute = response.body().getData();
                    for(V1_CapacityVsAllocatedOrderModel.Datum d : BookedMinute)
                    {
                        rBookedMinute = d;
                        final V1_CapacityVsAllocatedOrderModel.Datum finalName = rBookedMinute;
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                    ...
                    capacityVsAllocatedAdapter = new V1_CapacityVsAllocatedAdapter(V1_CapacityVsAllocatedReportActivity.this, R.layout.plan_vs_booked_report_layout, modelArrayList);
                    planBookedGridView.setAdapter(capacityVsAllocatedAdapter);
            ...
            @Override
            public void onFailure(Call<V1_CapacityVsAllocatedOrderModel> call, Throwable t) {
                hideDialog();
            }
        });
    }

    private ArrayList<V1_CapacityVsAllocatedOrderModelClass> getModel() {
        ArrayList<V1_CapacityVsAllocatedOrderModelClass> list = new ArrayList<>();
        ...
        allocatedMinuteArray = new String[allocatedMinuteList.size()];
        for(int i = 0; i < allocatedMinuteList.size(); i++)
        {
            allocatedMinuteArray[i] = allocatedMinuteList.get(i);
        }
        ...
        double[] longPlan = new double[allocatedMinuteArray.length];
        for (int i = 0; i < allocatedMinuteArray.length; i++)
            longPlan[i] = Double.parseDouble(allocatedMinuteArray[i]);
        ...
        for(int i = 0; i < rCompanyNameArray.length; i++){
            V1_CapacityVsAllocatedOrderModelClass capacityVsAllocatedModelClass = new V1_CapacityVsAllocatedOrderModelClass();
            capacityVsAllocatedModelClass.setCompanyName(rCompanyNameArray[i]);
            capacityVsAllocatedModelClass.setLocationName(rLocationNameArray[i]);
            capacityVsAllocatedModelClass.setMonth(monthNameArray[i]);
            capacityVsAllocatedModelClass.setAllocated(String.valueOf(allocatedMinuteArray[i]));
            capacityVsAllocatedModelClass.setCapacity(String.valueOf(capacityMinuteArray[i]));
            list.add(capacityVsAllocatedModelClass);
        }
        return list;
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(V1_CapacityVsAllocatedReportActivity.this, V1_MenuActivity.class);
    ...
    private void datepicker(final Button setdate) {
        ...
        // date picker dialog
        datePickerDialog = new DatePickerDialog(V1_CapacityVsAllocatedReportActivity.this,
