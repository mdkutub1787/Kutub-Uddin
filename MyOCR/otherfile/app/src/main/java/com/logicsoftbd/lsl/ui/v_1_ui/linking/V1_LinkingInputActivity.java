...
import com.logicsoftbd.lsl.data.network.v1_model.V1_LinkingInputModelClass;
...
public class V1_LinkingInputActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "V1_LinkingInputActivity";
    ...
    public static ArrayList<V1_LinkingInputModel> modelArrayList;
    private ArrayList<V1_LinkingInputModel> list;
    public static ArrayList<V1_LinkingInputModel> updatelist;
    private V1_LinkingInputModel inputModelClass;
    private V1_CustomLinkingInputAdapter customSewingInputAdapter;
    private V1_LinkingInputAdapter adapter;
...
//    private int updatemenu = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v1_linking_input);
...
//        endDate.setText(currentDate);
        ...
        modelArrayList = new ArrayList<V1_LinkingInputModel>();
        adapter = new V1_LinkingInputAdapter(getApplicationContext(), R.layout.linking_input_object_layout, modelArrayList);
...
//        });
    ...
    private void barcodeScanMethod() {
        ...
        if(!barcode.isEmpty())
        {
            ...
            intent.putExtra("qc", "linking_input");
        ...
        apiInterface.getBundkeWiseSewingInputClassCall().enqueue(new Callback<V1_BundleWiseSewingInputClass>() {
            ...
            public void onFailure(Call<V1_BundleWiseSewingInputClass> call, Throwable t) {
                if (t instanceof IOException) {
                    Toast.makeText(V1_LinkingInputActivity.this, "No network available, please check your WiFi or Data connection", Toast.LENGTH_SHORT).show();
                    hideDialog();
                }
                else {
        ...
        sCompany.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(company != 0)
                {
                    ...
                    Toast.makeText(V1_LinkingInputActivity.this, "Please Configure Your Tab..", Toast.LENGTH_SHORT).show();
                }
...
//        sLineNo.setAdapter(adapterLine);
    ...
    private void setAdapterData_Location() {
        ArrayAdapter<String> adapterLocation = new ArrayAdapter<String>(V1_LinkingInputActivity.this, R.layout.sewing_spinner_layout, locationArray);
        sLocation.setAdapter(adapterLocation);
...
//        }
    ...
    private void sendReuestToServerAfterScan(int lineId) {
        if(lineId > 0)
        {
            if (barcodeNumber != null && type_entry.equals("linking_input"))
            {
...
//                break;
            case R.id.saveBT:
                ...
                break;
            case R.id.toolbar:
                Intent intent = V1_MenuActivity.getStartIntent(V1_LinkingInputActivity.this);
                startActivity(intent);
                finish();
        }
    }
    ...
    private void sewingInputGetDataMethod(String barcode) {
        apiInterface.gerLinkingInputModelClassCall(sewingcompanyId, barcode, 55).enqueue(new Callback<V1_LinkingInputModelClass>() {
            @Override
            public void onResponse(Call<V1_LinkingInputModelClass> call, Response<V1_LinkingInputModelClass> response) {
                hideDialog();
                if(response.isSuccessful())
                {
                    ...
                    if(message.equals("")){
                        ...
                        Toast.makeText(V1_LinkingInputActivity.this, message, Toast.LENGTH_SHORT).show();
                    }

                }
                else {
                    Toast.makeText(V1_LinkingInputActivity.this, "Barcode already scanned Or Invalid Id", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<V1_LinkingInputModelClass> call, Throwable t) {
                if (t instanceof IOException) {
                    Toast.makeText(V1_LinkingInputActivity.this, "No network available, please check your WiFi or Data connection", Toast.LENGTH_SHORT).show();
                    hideDialog();
                }
    ...
    private void setDataInList() {
        ...
        inputModelClass = new V1_LinkingInputModel();
    ...
    private void postDataToServer_sewing_input() {
        if(checkNetworkConnection())
        {
            ...
            new V1_LinkingInputActivity.HTTPAsyncTask().execute(String.format("%s"+"logic-api/index.php/api/android/save_update_linking_input_output", urladdress));
        }
        else
    ...
    private class  HTTPAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("OK")) {
                Toast.makeText(V1_LinkingInputActivity.this, "সফলভাবে সংরক্ষিত", Toast.LENGTH_SHORT).show();
                if(arrayCutNo != null && arrayCutNo.length > 0)
                {
                    Intent intent = new Intent(V1_LinkingInputActivity.this, V1_LinkingInputActivity.class);
...
//        alertDialog.show();
    ...
    private JSONObject buildJsonObject() throws JSONException{
        ...
        save_obj.put("production_type", 55);
...
//                    customDialogPendingList = new CustomDialogPendingList(LinkingInputActivity.this, pendingAdapter);
...
//                    customDialogPendingList.show();
            ...
            public void onFailure(Call<V1_SewingInputPendingModelClass> call, Throwable t) {
                Toast.makeText(V1_LinkingInputActivity.this, "Data not Found !", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void datepicker(final Button setdate) {
        ...
        // date picker dialog
        datePickerDialog = new DatePickerDialog(V1_LinkingInputActivity.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                //logoutUser();
            case R.id.config:
                startActivity(new Intent(V1_LinkingInputActivity.this, V1_ConfigActivity.class));
            default:
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(V1_LinkingInputActivity.this, V1_MenuActivity.class);
        startActivity(intent);
        finish();
    }
