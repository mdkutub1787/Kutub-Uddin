...
public class CompactingDefaultResponse {
    ...
    public class Resultset {
        ...
        @SerializedName("service_company_outbound")
        @Expose
        private List<ServiceCompanyOutbound> serviceCompanyOutbound = null;
        ...
        public List<ServiceCompanyOutbound> getServiceCompanyOutbound() {
            return serviceCompanyOutbound;
        }

        public void setServiceCompanyOutbound(List<ServiceCompanyOutbound> serviceCompanyOutbound) {
            this.serviceCompanyOutbound = serviceCompanyOutbound;
        }
    ...
    public class ServiceCompanyOutbound {
