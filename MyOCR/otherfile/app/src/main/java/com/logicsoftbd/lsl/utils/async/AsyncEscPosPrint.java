package com.logicsoftbd.lsl.utils.async;
...
import com.logicsoftbd.lsl.posPrinter.EscPosCharsetEncoding;
...
//                        .setTitle("Success")
//                        .setMessage("Congratulation ! The sticker are printed !")
//                        .show();
                Toasty.success(context, "Sticker printed successfully.", Toast.LENGTH_SHORT, true).show();
                break;
