...
public class V2_AOPPrintDefectAdapter extends RecyclerView.Adapter<V2_AOPPrintDefectAdapter.ViewHolder> {
    private static final String TAG = "FinishProductionSlittin";
    List<V1_BarcodeDetailsFromBatchFinishQCResponse.AopPrint> dtlsIndexArrayList;
    Context context;
    OnAOPHeadListener mOnSelectListener;

    public V2_AOPPrintDefectAdapter(List<V1_BarcodeDetailsFromBatchFinishQCResponse.AopPrint> dtlsIndexArrayList, Context context, OnAOPHeadListener mOnSelectListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull V2_AOPPrintDefectAdapter.ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        OnAOPHeadListener onKnittingDefectClick;

        public ViewHolder(@NonNull View itemView, OnAOPHeadListener onSelectClick) {
            super(itemView);
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.defectNameTV) {
                onKnittingDefectClick.onAOPDefectClick(getAdapterPosition(), v);
            }
        }
    }

    public interface OnAOPHeadListener {
        void onAOPDefectClick(int position, View v);
    }
}
