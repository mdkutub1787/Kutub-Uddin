...
public class PurposeResponse implements Serializable {
    ...
    private Challan data  = new Challan();
    ...
    public static class Challan implements Serializable{
        ...
        private List<MasterPart> masterPart = new ArrayList<>();
        ...
        public static class MasterPart implements Serializable {
            ...
            public MasterPart(Integer id, String purpose) {
                this.id = id;
