...
public class V1_GreyStoreRejectFabricBagRecyclerViewAdapter extends RecyclerView.Adapter<V1_GreyStoreRejectFabricBagRecyclerViewAdapter.ViewHolder> {
    private List<V1_GreyStoreRejectBagReceiveResponse.ResultSet> bagKeepingResponses;
    private Context context;
    private OnRemoveHeadListener mOnRemoveHeadListener;

    public V1_GreyStoreRejectFabricBagRecyclerViewAdapter(List<V1_GreyStoreRejectBagReceiveResponse.ResultSet> bagKeepingResponses, OnRemoveHeadListener mOnRemoveHeadListener, Context context) {
    ...
    @NonNull
    @Override
    public V1_GreyStoreRejectFabricBagRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        V1_GreyStoreRejectBagReceiveResponse.ResultSet currentItem = bagKeepingResponses.get(position);
