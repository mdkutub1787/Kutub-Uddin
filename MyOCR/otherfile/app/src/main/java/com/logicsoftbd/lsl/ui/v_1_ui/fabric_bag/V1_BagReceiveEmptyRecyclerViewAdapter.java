...
public class V1_BagReceiveEmptyRecyclerViewAdapter extends RecyclerView.Adapter<V1_BagReceiveEmptyRecyclerViewAdapter.ViewHolder> {
    private List<V1_BagEmptyReceiveResponse.ResultSet> bagKeepingResponses;
    private Context context;
    private OnRemoveHeadListener mOnRemoveHeadListener;

    public V1_BagReceiveEmptyRecyclerViewAdapter(List<V1_BagEmptyReceiveResponse.ResultSet> bagKeepingResponses, OnRemoveHeadListener mOnRemoveHeadListener, Context context) {
    ...
    @NonNull
    @Override
    public V1_BagReceiveEmptyRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bag_receive_empty_item_layout, parent, false);
