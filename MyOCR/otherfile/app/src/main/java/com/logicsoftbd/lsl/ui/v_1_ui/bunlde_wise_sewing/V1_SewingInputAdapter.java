...
public class V1_SewingInputAdapter extends ArrayAdapter<V1_SewingInputModelClass>{
     ArrayList<V1_SewingInputModelClass> sInputModelClasses;
     LayoutInflater vi;
    int Resource;

    public V1_SewingInputAdapter(@NonNull Context context, int resource, ArrayList<V1_SewingInputModelClass> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ViewHolder holder;
            ...
            holder = new V1_SewingInputAdapter.ViewHolder();
