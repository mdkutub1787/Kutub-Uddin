...
import com.logicsoftbd.lsl.data.network.v1_model.V1_LineSewingOutputModelClass;
...
public class V1_LineWiseSewingOutputActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static ArrayList<V1_LineSewingOutputModelClass> modelArrayList;
    private V1_LineSewingOutputModelClass inputModelClass;
    private V1_LineWiseSewingOutputAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v1_line_wise_sewing_output);
...
//        updatemenu = intent.getIntExtra("u", 0);
    ...
    private void initialization() {
        ...
        modelArrayList = new ArrayList<V1_LineSewingOutputModelClass>();
        adapter = new V1_LineWiseSewingOutputAdapter(getApplicationContext(), R.layout.sewing_output_line_object_layout, modelArrayList);
        ...
        apiInterface.getBundkeWiseSewingInputClassCall().enqueue(new Callback<V1_BundleWiseSewingInputClass>() {
            ...
            public void onFailure(Call<V1_BundleWiseSewingInputClass> call, Throwable t) {
                if (t instanceof IOException) {
                    Toast.makeText(V1_LineWiseSewingOutputActivity.this, "No network available, please check your WiFi or Data connection", Toast.LENGTH_SHORT).show();
                    hideDialog();
                }
                else {
        ...
        sCompany.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(company > 0)
                {
                    ...
                    Toast.makeText(V1_LineWiseSewingOutputActivity.this, "Please Configure Your Tab..", Toast.LENGTH_SHORT).show();
                }
            }
...
//        sLineNo.setAdapter(adapterLine);
    ...
    private void setAdapterData_Location() {
        ArrayAdapter<String> adapterLocation = new ArrayAdapter<String>(V1_LineWiseSewingOutputActivity.this, R.layout.sewing_spinner_layout, locationArray);
        sLocation.setAdapter(adapterLocation);
...
//        }
    ...
    private void sendReuestToServerAfterScan(int lineId) {
        if(lineId > 0)
        {
            if (barcodeNumber != null && type_entry.equals("line_wise_sewing_output"))
            {
...
//                break;
            case R.id.saveBT:
                ...
                break;
            case R.id.toolbar:
                Intent intent = V1_MenuActivity.getStartIntent(V1_LineWiseSewingOutputActivity.this);
    ...
    private void barcodeScanMethod() {
        ...
        if(!barcode.isEmpty())
        {
            ...
            intent.putExtra("qc", "line_wise_sewing_output");
            startActivity(intent);
        }
    }
...
//        showDialog();
        hideSoftKeyboard();
        apiInterface.getLineWiseSewingOutputModelClassCall(sewingcompanyId, barcode, 13).enqueue(new Callback<V1_BundleWiseSewingOutputClass>() {
            @Override
            public void onResponse(Call<V1_BundleWiseSewingOutputClass> call, Response<V1_BundleWiseSewingOutputClass> response) {
                ...
                if(response.isSuccessful())
                {
                    ...
                    if(message.equals("")){
                        ...
                        Toast.makeText(V1_LineWiseSewingOutputActivity.this, message, Toast.LENGTH_SHORT).show();
                    }

                }
                else {
                    Toast.makeText(V1_LineWiseSewingOutputActivity.this, "Barcode already scanned Or Invalid Id", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void setDataInList() {
        ...
        inputModelClass = new V1_LineSewingOutputModelClass();
    ...
    private void postDataToServer_sewing_input() {
        ...
        {
            new V1_LineWiseSewingOutputActivity.HTTPAsyncTask().execute(String.format("%s"+"logic-api/index.php/api/android/save_update_sewing_input_output", urladdress));
        }
        else
    ...
    private class  HTTPAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if(result.equals("OK")) {
                Toast.makeText(V1_LineWiseSewingOutputActivity.this, "সফলভাবে সংরক্ষিত", Toast.LENGTH_SHORT).show();
                if(arrayCutNo != null && arrayCutNo.length > 0)
                {
                    Intent intent = new Intent(V1_LineWiseSewingOutputActivity.this, V1_LineWiseSewingOutputActivity.class);
...
//                startActivity(intent);
    ...
    private JSONObject buildJsonObject() throws JSONException{
        ...
        save_obj.put("production_type", 13);
    ...
    private void timePickerMethor() {
        ...
        mTimePicker = new TimePickerDialog(V1_LineWiseSewingOutputActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void onBackPressed() {
        super.onBackPressed();
//        Intent intent = new Intent(V1_LineWiseSewingOutputActivity.this, V1_MenuActivity.class);
//        startActivity(intent);
        finish();
    }
