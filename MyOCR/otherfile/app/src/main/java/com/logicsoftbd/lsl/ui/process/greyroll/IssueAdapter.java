...
public class IssueAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private List<BarcodeIssueResponse.Challan.ProductBarcode> mProcessResponseList = new ArrayList<>();

    public IssueAdapter(List<BarcodeIssueResponse.Challan.ProductBarcode> openSourceResponseList) {
    ...
    public void addItems(List<BarcodeIssueResponse.Challan.ProductBarcode> repoList) {
        if(mProcessResponseList != null && mProcessResponseList.size() > 0)
    ...
    public class ViewHolder extends BaseViewHolder {
       ...
       /* @BindView(R.id.sub_text_5)
        ...
        public void onBind(final int position) {
            ...
            final BarcodeIssueResponse.Challan.ProductBarcode repo = mProcessResponseList.get(position);
